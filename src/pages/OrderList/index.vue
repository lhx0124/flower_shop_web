<template>
    <el-container>
        ...
        <el-header style="text-align:right;margin-top: 10px;">
            <el-input type="text" v-model="keywords" auto-complete="off" placeholder="请输入收货地址查询"
            ...
            <div style="height: 480px;width: 100%;">
                <el-main>
                    <el-table :data="tableData" border style="width: 100%;text-align: center;" height="470px">
                        ...
                        <el-table-column prop="buy" label="收件人"></el-table-column>
        ...
        <el-dialog title="请输入订单数据" :visible.sync="DialogVisible" width="40%">
            <el-form :model="Form" status-icon :rules="Rules" ref="Form">
                ...
                <el-form-item label="收货人" :label-width="formLabelWidth" prop="buy">
                    <el-input v-model="Form.buy" autocomplete="off" style="width:90%"></el-input>
                </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            Rules: {
                address: [
                    { required: true, message: '请输入收货', trigger: 'blur' },
                ],
                buy: [
    ...
    methods: {
        search() {
            request.get("/api/admin/searchOrder", {
                params: {
        ...
        save() {
            if (this.Form.id) {
                request.put("/api/admin/upDateOrder", this.Form).then(res => {
                    if (res.code == "0") {
                ...
                this.$refs['Form'].validate((valid) => {
                    if (valid) {
                        request.post("/api/admin/addOrder", this.Form).then(res => {
                            if (res.code == '0') {
        ...
        handleDelete(id) {
            request.delete("/api/admin/deleteOrder/" + id).then(res => {
                if (res.code == "0") {
